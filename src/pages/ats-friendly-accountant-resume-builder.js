...
const AccountantResume = ({ 
  ...
  // --- Default item factories for Accountant ---
  ...
  const defaultIndustryExpertise = () => ({
    name: '',
    isEditing: false,
    editIndex: null
  });
  ...
  // Font size state - Professional accounting fonts
  ...
  const hasContent = () => {
    return (
      ...
      formData.industryExpertise.length > 0
    );
  };
  ...
  const AccountantTemplate = ({ formData }) => {
    ...
    return (
      <div className={styles.accountantTemplate}>
          ...
          <section className={styles.section}>
            ...
            {formData.certifications.map((cert, i) => (
              <div key={i} className={styles.certificationItem} style={{ fontSize: `${fontSizes.certificationText}pt` }}>
                ...
                {cert.credentialNumber && ` (Credential #: ${cert.credentialNumber})`}
        ...
        {hasLicenses && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>LICENSES</h2>
            {formData.licenses.map((l, i) => (
              <div key={i} className={styles.licenseItem} style={{ fontSize: `${fontSizes.regularText}pt` }}>
        ...
        {hasIndustryExpertise && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>INDUSTRY EXPERTISE</h2>
            <ul className={styles.skillsList}>
              {formData.industryExpertise.map((exp, i) => <li key={i} style={{ fontSize: `${fontSizes.skillText}pt` }}>{exp.name}</li>)}
            </ul>
          </section>
        )}
      </div>
    ...
    <div className={styles.resumeBuilder} lang="en-US">
      ...
      <nav className={styles.breadcrumb} aria-label="Breadcrumb">
        <ol>
          ...
          <li>
            <Link href="/ats-friendly-accountant-resume-builder" className={styles.breadcrumbLink} prefetch={false}>
              <span className={styles.breadcrumbText}>Free Accounting Templates</span>
            </Link>
          </li>
        </ol>
      </nav>
          ...
          <div className={styles.heroContent}>
            <div className={styles.trustBadge}>
              ...
              <span className={styles.trustBadgeText}>
                Rated 4.8/5 by 42,365+ Accounting Professionals | Best Free Accounting Resume Builder 2026
              </span>
            </div>
            ...
            <p className={styles.heroSubtitle}>
              Create a <strong className={styles.heroHighlight}>professional, ATS-optimized accounting resume for free in minutes.</strong> Our accounting resume builder ensures your financial expertise and credentials get noticed by firms and employers worldwide.
            </p>
            ...
            <div className={styles.ctaButtons}>
              <button
                ...
                aria-label="Start building your free accounting resume now—no sign-up required"
              >
                <span className={styles.buttonText}>Start Building Your Accounting Resume Now</span>
              ...
              <button
                ...
                aria-label="Download accounting resume as PDF"
                disabled={isGeneratingPDF || !hasContent()}
              >
                <FiDownload className={styles.buttonIcon} />
                <span className={styles.buttonText}>Download Accounting Resume PDF</span>
              </button>
            </div>
            ...
            <div className={styles.heroStats}>
              <div className={styles.statItem}>
                ...
                <span className={styles.statLabel}>Accounting Resumes Created</span>
              </div>
              <div className={styles.statItem}>
              ...
              <div className={styles.statItem}>
                ...
                <span className={styles.statLabel}>Faster Accounting Hires</span>
              </div>
              <div className={styles.statItem}>
            ...
            <div className={styles.accountingBadges}>
              <div className={styles.badgeGrid}>
                <span className={styles.badgeItem}>CPA Resume Templates</span>
                <span className={styles.badgeItem}>Audit Resume Templates</span>
                <span className={styles.badgeItem}>Tax Specialist Resumes</span>
                <span className={styles.badgeItem}>Financial Analyst CVs</span>
                <span className={styles.badgeItem}>Controller Resumes</span>
                <span className={styles.badgeItem}>Big 4 Templates</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.resumePreviewCard}>
              <div className={styles.previewContent}>
                <div
                  ...
                  ref={resumeRef}
                >
                  <AccountantTemplate formData={formData} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.formContent}>
            ...
            {activeSection === 'personal' && (
              <div className={styles.formSectionContent}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Full Name*
                      <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} placeholder="John Smith, CPA, CMA" required className={styles.formInput} />
                    </label>
                    <label className={styles.formLabel}>
                      Email*
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="john.smith@accounting.com" required className={styles.formInput} />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                ...
                <div className={styles.formCard}>
                  <label className={styles.formLabel}>
                    Professional Accounting Summary*
                    <textarea
                      name="summary"
                      value={formData.summary}
                      onChange={handleInputChange}
                      placeholder="Results-driven CPA with 8+ years of experience in public accounting and corporate finance. Expertise in financial reporting, audit compliance, and tax strategy. Proven track record of optimizing financial processes and driving cost savings of over $2M annually. Strong analytical skills with proficiency in GAAP, IFRS, and financial modeling."
                      required
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Senior Accountant, CPA" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <input 
                      ...
                      placeholder="Audit & Assurance / Financial Services" 
                      className={styles.formInput} 
                    />
                  </label>
                  <div className={styles.formGroup}>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <textarea 
                      ...
                      placeholder="• Managed full-cycle accounting for $50M+ revenue portfolio
                  ...
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="University of Pennsylvania - Wharton School" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
            ...
            {activeSection === 'certifications' && (
              <div className={styles.formSectionContent}>
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Certified Public Accountant (CPA)" 
                          className={styles.formInput} 
                        />
                      </label>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="American Institute of CPAs (AICPA)" 
                          className={styles.formInput} 
                        />
                      </label>
                    </div>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="California Board of Accountancy" 
                          className={styles.formInput} 
                        />
                      </label>
                    </div>
                ...
                <div className={styles.formCard}>
                  ...
                  <div className={styles.skillsInput}>
                    <input 
                      value={currentIndustryExpertise.name} 
                      onChange={(e) => setCurrentIndustryExpertise({ ...currentIndustryExpertise, name: e.target.value })} 
                      placeholder="Financial Services, Manufacturing, Technology, Healthcare, Retail" 
                      className={styles.formInput} 
                    />
                    <div className={styles.formActions}>
                      <button 
                        ...
                        className={styles.addButton} 
                        disabled={!currentIndustryExpertise.name.trim()}
                      >
                        <FiPlus /> {currentIndustryExpertise.isEditing ? 'Update Expertise' : 'Add Expertise'}
                      </button>
                      {currentIndustryExpertise.isEditing && (
                        <button 
                          type="button" 
                          onClick={() => setCurrentIndustryExpertise(defaultIndustryExpertise())} 
                          className={styles.cancelButton}
                        >
                          <FiX /> Cancel
                        </button>
                  ...
                  <div className={styles.itemsList}>
                    {formData.industryExpertise.map((exp, i) => (
                      <div key={i} className={styles.listItem}>
                        <span>{exp.name}</span>
                        <div className={styles.itemActions}>
                          <button onClick={() => editIndustryExpertise(i)} className={styles.editButton}><FiEdit2 /></button>
                          <button onClick={() => deleteIndustryExpertise(i)} className={styles.deleteButton}><FiTrash2 /></button>
                        </div>
                      </div>
                    ))}
                    {formData.industryExpertise.length === 0 && <p className={styles.emptyMessage}>No industry expertise added yet</p>}
                  </div>
                </div>
              </div>
            )}
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="QuickBooks, SAP, Oracle Financials" 
                          className={styles.formInput} 
                        />
                      </label>
                      <label className={styles.formLabel}>
                        Proficiency Level
                        <select 
                          value={currentSoftware.level} 
                          onChange={(e) => setCurrentSoftware({ ...currentSoftware, level: e.target.value })} 
                          className={styles.formSelect}
                        >
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Financial Analysis, GAAP Compliance" 
                          className={styles.formInput} 
                        />
                      </label>
                      <label className={styles.formLabel}>
        ...
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              Everything you need to know about creating professional accounting resumes with our tool.
            </p>
          </div>
      ...
      <section className={styles.ctaSection} aria-labelledby="cta-title">
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            <h2 className={styles.ctaTitle} id="cta-title">Ready to Advance Your Accounting Career?</h2>
            <p className={styles.ctaSubtitle}>
              Join 3 million+ accounting professionals who landed their dream jobs with our free ATS-friendly accounting resume builder.
            </p>
            <div className={styles.ctaButtons}>
              <button
                onClick={() => setActiveSection('personal')}
                className={styles.ctaButton}
                aria-label="Create your free accounting resume now—no sign-up required"
              >
                <span className={styles.ctaButtonText}>Create Your Free Accounting Resume Now</span>
                <FiArrowRight className={styles.ctaButtonIcon} />
              </button>
            </div>
            <div className={styles.ctaGuarantee}>
              <FiCheck className={styles.guaranteeIcon} />
              <span className={styles.guaranteeText}>No credit card required • Free forever • Download in minutes • ATS Optimized for Accounting</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.fullPreviewModal} onClick={() => setShowFullPreview(false)}>
          <div className={styles.fullPreviewContent} onClick={(e) => e.stopPropagation()}>
            <div className={styles.fullPreviewHeader}>
              <h3>Full Accounting Resume Preview</h3>
