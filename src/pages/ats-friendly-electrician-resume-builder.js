...
const Resume = ({ 
  ...
  const faqs = [
    {
      question: "Is this electrician resume builder really free with no hidden costs?",
      answer: "Yes, our electrician resume builder is completely free with no hidden costs or watermarks. Create, edit, and download your professional electrical resume in PDF format without any payment required."
    },
    {
      question: "What does ATS-friendly mean for electrician resumes?",
      answer: "ATS-friendly means our electrical resume templates are optimized to pass through Applicant Tracking Systems used by electrical contractors, construction companies, and industrial employers globally."
    },
    {
      question: "Can I download my electrician resume as PDF without creating an account?",
      answer: "Absolutely! Download your professional electrician resume in PDF format without creating an account. Everything is completely free and accessible immediately for electricians worldwide."
    },
    {
      question: "How many electrician resume templates are available for free?",
      answer: "We offer professionally designed ATS-friendly electrician resume templates for industrial, commercial, residential, maintenance, and specialized electrical fields. All templates are completely free and optimized for electrical hiring."
    },
    {
      question: "How does your electrician resume builder work?",
      answer: "Our builder uses ATS-optimized electrical templates with proper industry terminology formatting. We guide you to highlight electrical experience, certifications, and specialized skills that employers look for."
    },
    {
      question: "Can I edit my electrician resume after downloading it?",
      answer: "Yes, you can always come back and edit your electrical resume. Your work saves automatically, and you can download updated versions as many times as needed—completely free."
    }
  ];
  ...
  const ElectricianTemplate = ({ formData }) => {
    ...
    return (
      <div className={styles.electricianTemplate}>
        ...
        {hasExperience && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>ELECTRICAL EXPERIENCE</h2>
    ...
    <div className={styles.resumeBuilder} lang="en-US">
      ...
      <nav className={styles.breadcrumb} aria-label="Breadcrumb">
        <ol>
          ...
          <li>
            <Link href="/ats-friendly-electrician-resume-builder" className={styles.breadcrumbLink} prefetch={false}>
              <span className={styles.breadcrumbText}>Free Electrical Template</span>
            </Link>
          </li>
        </ol>
      </nav>
        ...
        <div className={styles.container}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Create a <strong className={styles.heroHighlight}>professional, ATS-optimized electrician resume for free in minutes.</strong> Our electrical resume builder ensures your experience and certifications get noticed by employers globally.
            </p>
            ...
            <div className={styles.ctaButtons}>
              <button
                ...
                aria-label="Start building your free electrician resume now—no sign-up required"
              >
                <span className={styles.buttonText}>Start Building Your Electrician Resume Now</span>
              ...
              <button
                ...
                aria-label="Download electrician resume as PDF"
                disabled={isGeneratingPDF || !hasContent()}
              >
                <FiDownload className={styles.buttonIcon} />
                <span className={styles.buttonText}>Download Electrician Resume PDF</span>
              </button>
            </div>
            ...
            <div className={styles.electricalBadges}>
              <div className={styles.badgeGrid}>
                ...
                <span className={styles.badgeItem}><FiGrid /> Commercial Electrician</span>
                <span className={styles.badgeItem}><FiHome /> Residential Electrician</span>
                <span className={styles.badgeItem}><FiTool /> Maintenance Electrician</span>
                <span className={styles.badgeItem}><FiWifi /> Data & Telecom</span>
                <span className={styles.badgeItem}><FiBattery /> Renewable Energy</span>
                <span className={styles.badgeItem}><FiCpu /> Automation & Controls</span>
                <span className={styles.badgeItem}><FiCloud /> Smart Grid Systems</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.resumePreviewCard}>
              <div className={styles.previewContent}>
                <div
                  ...
                  ref={resumeRef}
                >
                  <ElectricianTemplate formData={formData} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.formSection}>
          <div className={styles.formNavigation}>
            {[
              ...
              { id: 'experience', label: 'Electrical Experience', icon: <FiTool /> },
              { id: 'education', label: 'Education', icon: <FiBook /> },
              { id: 'certifications', label: 'Licenses & Certs', icon: <FiShield /> },
              { id: 'skills', label: 'Skills & Specialties', icon: <FiZap /> },
          ...
          <div className={styles.formContent}>
            ...
            {activeSection === 'personal' && (
              <div className={styles.formSectionContent}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Full Name*
                      <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} placeholder="John Smith, Master Electrician" required className={styles.formInput} />
                    </label>
                    <label className={styles.formLabel}>
                      Email*
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="john.smith@electrical.com" required className={styles.formInput} />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                ...
                <div className={styles.formCard}>
                  ...
                  <p className={styles.sectionDescription}>Add your professional electrical profiles (LinkedIn, portfolio, etc.)</p>
                  <div className={styles.socialInput}>
                    ...
                    >
                      ...
                      <option value="GitHub">GitHub (for automation/code)</option>
            ...
            {/* Electrical Experience Section */}
            {activeSection === 'experience' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiTool /> Electrical Experience</h3>
                <p className={styles.sectionDescription}>List your electrical positions in reverse chronological order (most recent first)</p>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Master Electrician, Project Lead" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Global Electrical Contractors Inc." 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <input 
                      ...
                      placeholder="Industrial Manufacturing / Commercial Construction" 
                      className={styles.formInput} 
                    />
                  </label>
                  <div className={styles.formGroup}>
                  ...
                  <label className={styles.formLabel}>
                    Key Electrical Responsibilities & Achievements*
                    <textarea 
                      value={currentExperience.description} 
                      onChange={(e) => setCurrentExperience({ ...currentExperience, description: e.target.value })} 
                      placeholder="• Led electrical installation for $15M industrial manufacturing facility
...
• Maintained zero safety incidents over 5-year period"
                      required 
                      className={styles.formTextarea} 
                      rows="8" 
                    />
                  ...
                  <div className={styles.formActions}>
                    ...
                    >
                      <FiPlus /> {currentExperience.isEditing ? 'Update Electrical Experience' : 'Add Electrical Experience'}
                    </button>
                ...
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Your Electrical Experience</h4>
                  {formData.experience.length === 0 ? (
                    <p className={styles.emptyMessage}>No electrical experience added yet</p>
                  ) : (
                    <div className={styles.itemsList}>
                      {formData.experience.map((exp, i) => (
                        <div key={i} className={styles.listItem}>
            ...
            {activeSection === 'education' && (
              <div className={styles.formSectionContent}>
                ...
                <p className={styles.sectionDescription}>List your electrical education, degrees, apprenticeships, and relevant training</p>
                  ...
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="National Electrical Training Institute" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Electrical Apprenticeship, Associate Degree in Electrical Technology" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
            ...
            {activeSection === 'certifications' && (
              <div className={styles.formSectionContent}>
                ...
                {/* Licenses */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Electrical Licenses & Registrations</h4>
                  <p className={styles.sectionDescription}>Add your professional electrical licenses (Master Electrician, Journeyman, etc.)</p>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      License Name*
                      <input 
                        ...
                        placeholder="Master Electrician License" 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="State Electrical Board" 
                        className={styles.formInput} 
                      />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Country/Region
                      <input 
                        value={currentLicense.country} 
                        onChange={(e) => setCurrentLicense({ ...currentLicense, country: e.target.value })} 
                        placeholder="USA, UK, Canada, Australia, EU" 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                  ...
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        onChange={(e) => setCurrentLicense({ ...currentLicense, issueDate: e.target.value })} 
                        placeholder="Month Year" 
                        className={styles.formInput} 
                      />
                    </label>
                ...
                <div className={styles.formCard}>
                  ...
                  <p className={styles.sectionDescription}>Add your electrical certifications (OSHA, NFPA, manufacturer-specific, etc.)</p>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Certification Name*
                      <input 
                        ...
                        placeholder="OSHA 30-Hour, NFPA 70E, Siemens PLC Certified" 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="OSHA, NFPA, Siemens, ABB" 
                        className={styles.formInput} 
                      />
                    </label>
                  </div>
                ...
                <div className={styles.formCard}>
                  ...
                  <p className={styles.sectionDescription}>Add your professional electrical organization memberships</p>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Organization*
                      <input 
                        ...
                        placeholder="International Brotherhood of Electrical Workers (IBEW)" 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
            ...
            {activeSection === 'skills' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiZap /> Skills & Specialties</h3>
                
                {/* Areas of Expertise */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Areas of Electrical Expertise</h4>
                  <p className={styles.sectionDescription}>List your electrical specialties and areas of expertise</p>
                  <div className={styles.skillsInput}>
                    <input 
                      value={currentSpecialty.name} 
                      onChange={(e) => setCurrentSpecialty({ ...currentSpecialty, name: e.target.value })} 
                      placeholder="Industrial Automation, Renewable Energy Systems, PLC Programming" 
                      className={styles.formInput} 
                    />
                    <div className={styles.formActions}>
                      <button 
                ...
                <div className={styles.formCard}>
                  ...
                  <p className={styles.sectionDescription}>List your specific technical skills and proficiencies</p>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Skill*
                      <input 
                        ...
                        placeholder="PLC Programming (Siemens, Allen-Bradley)" 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                  ...
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Spanish, German, Arabic" 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
        ...
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              Everything you need to know about creating professional electrician resumes with our tool.
            </p>
          </div>
      ...
      <section className={styles.ctaSection} aria-labelledby="cta-title">
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            <h2 className={styles.ctaTitle} id="cta-title">Ready to Advance Your Electrical Career?</h2>
            <p className={styles.ctaSubtitle}>
              Join 2 million+ electricians who landed their dream jobs with our free ATS-friendly electrician resume builder.
            </p>
            <div className={styles.ctaButtons}>
              <button
                onClick={() => setActiveSection('personal')}
                className={styles.ctaButton}
                aria-label="Create your free electrician resume now—no sign-up required"
              >
                <span className={styles.ctaButtonText}>Create Your Free Electrician Resume Now</span>
                <FiArrowRight className={styles.ctaButtonIcon} />
              </button>
            </div>
            <div className={styles.ctaGuarantee}>
              <FiCheck className={styles.guaranteeIcon} />
              <span className={styles.guaranteeText}>No credit card required • Free forever • Download in minutes • ATS Optimized for Electrical Industry</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.fullPreviewModal} onClick={() => setShowFullPreview(false)}>
          <div className={styles.fullPreviewContent} onClick={(e) => e.stopPropagation()}>
            <div className={styles.fullPreviewHeader}>
              <h3>Full Electrician Resume Preview</h3>
