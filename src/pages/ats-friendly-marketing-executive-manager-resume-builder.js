...
const MarketingResume = ({ 
      ...
      const canvas = await html2canvas(el, {
        ...
        onclone: (doc) => {
          ...
          if (clone) {
            ...
            const regularTexts = clone.querySelectorAll(`.${styles.summaryText}, .${styles.certificationItem}, .${styles.awardItem}`);
  ...
  const MarketingTemplate = ({ formData }) => {
    ...
    return (
      <div className={styles.marketingTemplate}>
            ...
            {formData.experience.map((exp, i) => (
              <div key={i} className={styles.experienceItem}>
                <div className={styles.experienceHeader}>
                  ...
                  <p className={styles.company} style={{ fontSize: `${fontSizes.company}pt` }}>{exp.company}{exp.department && ` | ${exp.department}`} | {exp.startDate} – {exp.endDate || 'Present'}</p>
                </div>
        ...
        {hasProjects && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>KEY MARKETING PROJECTS</h2>
            {formData.projects.map((proj, i) => (
              <div key={i} className={styles.projectItem}>
                <div className={styles.projectHeader}>
                  <h3 style={{ fontSize: `${fontSizes.jobTitle}pt` }}>{proj.name}</h3>
                  <p className={styles.projectMeta} style={{ fontSize: `${fontSizes.company}pt` }}>
                    {proj.client && `${proj.client} | `}{proj.role} | {proj.duration}
                  </p>
                </div>
                <ul className={styles.bulletList}>
                  {proj.results.split('\n').filter(line => line.trim()).map((line, j) => <li key={j} style={{ fontSize: `${fontSizes.bulletText}pt` }}>{line}</li>)}
        ...
        {hasSkills && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>MARKETING SKILLS</h2>
            <div className={styles.skillsContainer}>
              {Array.from(new Set(formData.skills.map(s => s.category))).map(category => (
                <div key={category} className={styles.skillCategory}>
                  ...
                  <ul className={styles.skillsList}>
                    {formData.skills
                      ...
                      .map((s, i) => (
                        <li key={i} style={{ fontSize: `${fontSizes.skillText}pt` }}>{s.name}</li>
                      ))}
                  </ul>
                </div>
              ))}
        ...
        {hasAwards && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>AWARDS & RECOGNITION</h2>
            {formData.awards.map((award, i) => (
              <div key={i} className={styles.awardItem} style={{ fontSize: `${fontSizes.regularText}pt` }}>
    ...
    <div className={styles.resumeBuilder} lang="en-US">
      ...
      <nav className={styles.breadcrumb} aria-label="Breadcrumb">
        <ol>
          ...
          <li>
            <Link href="/ats-friendly-marketing-executive-manager-resume-builder" className={styles.breadcrumbLink} prefetch={false}>
              <span className={styles.breadcrumbText}>Free Marketing Template</span>
            </Link>
          </li>
        </ol>
      </nav>
        ...
        <div className={styles.container}>
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.heroTitle}>
              Free Marketing Resume Builder: Create Yours in 5 Minutes
            </h1>
            
            <p className={styles.heroSubtitle}>
              Create a <strong className={styles.heroHighlight}>professional, ATS-optimized marketing resume for free in minutes.</strong> Our marketing resume builder ensures your campaign results and strategic achievements get noticed by employers worldwide.
            </p>
            ...
            <div className={styles.ctaButtons}>
              ...
              >
                <span className={styles.buttonText}>Start Building Your Marketing Resume Now</span>
              ...
              >
                ...
                <span className={styles.buttonText}>Download Marketing Resume PDF</span>
              </button>
            </div>
            ...
            <div className={styles.marketingBadges}>
              <div className={styles.badgeGrid}>
                <span className={styles.badgeItem}>Marketing Executive</span>
                <span className={styles.badgeItem}>Digital Marketing</span>
                <span className={styles.badgeItem}>Brand Management</span>
                <span className={styles.badgeItem}>Social Media</span>
                <span className={styles.badgeItem}>Content Marketing</span>
                <span className={styles.badgeItem}>Marketing Director</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.resumePreviewCard}>
              <div className={styles.previewContent}>
                <div
                  ...
                  ref={resumeRef}
                >
                  <MarketingTemplate formData={formData} />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className={styles.formSectionContent}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    ...
                    <label className={styles.formLabel}>
                      Professional Title
                      <input type="text" name="title" value={formData.title} onChange={handleInputChange} placeholder="Marketing Executive | Digital Marketing Director" className={styles.formInput} />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Email*
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="alex.johnson@email.com" required className={styles.formInput} />
                    </label>
                    <label className={styles.formLabel}>
                      Phone
                  ...
                  <label className={styles.formLabel}>
                    Location
                    <input type="text" name="location" value={formData.location} onChange={handleInputChange} placeholder="New York, NY | Remote | London, UK" className={styles.formInput} />
                  </label>
                </div>

                <div className={styles.formCard}>
                  <label className={styles.formLabel}>
                    Professional Marketing Summary*
                    <textarea
                      name="summary"
                      value={formData.summary}
                      onChange={handleInputChange}
                      placeholder="Results-driven Marketing Executive with 10+ years of experience developing and executing strategic marketing initiatives that drive revenue growth and brand awareness. Proven track record of launching successful multi-channel campaigns, increasing market share, and building high-performing marketing teams. Expertise in digital transformation, brand strategy, and data-driven decision making."
                      required
                ...
                <div className={styles.formCard}>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <input 
                      ...
                      placeholder="Digital Marketing | Product Marketing | Brand Strategy" 
                      className={styles.formInput} 
                    />
                  </label>
                  <div className={styles.formGroup}>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <textarea 
                      ...
                      placeholder="• Led digital marketing strategy that increased online revenue by 45% in 12 months
• Managed $2M annual marketing budget with 25% ROI improvement
• Built and mentored a team of 8 marketing specialists across 3 regions
• Launched successful product campaign resulting in 15,000+ new customers
• Developed content strategy that increased organic traffic by 300%
• Implemented marketing automation reducing campaign execution time by 60%"
                      required 
                      className={styles.formTextarea} 
                      rows="8" 
                    />
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Google Analytics, SEO Strategy, Content Marketing" 
                          className={styles.formInput} 
                        />
                      </label>
                      <label className={styles.formLabel}>
                  ...
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Marketing Excellence Award" 
                          className={styles.formInput} 
                        />
                      </label>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="American Marketing Association" 
                          className={styles.formInput} 
                        />
                      </label>
                    </div>
                    <div className={styles.formGroup}>
                      ...
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Top 1% of marketing professionals nationwide" 
                          className={styles.formInput} 
                        />
                      </label>
                    </div>
                    <div className={styles.formActions}>
                      <button 
                        ...
                        onClick={addAward} 
                        className={styles.addButton} 
                        disabled={!currentAward.name.trim()}
                      >
                        <FiPlus /> {currentAward.isEditing ? 'Update Award' : 'Add Award'}
                      </button>
                      {currentAward.isEditing && (
                        <button 
                          type="button" 
                          onClick={() => setCurrentAward(defaultAward())} 
                          className={styles.cancelButton}
                        >
                          <FiX /> Cancel
                        </button>
                  ...
                  <div className={styles.itemsList}>
                    {formData.awards.map((award, i) => (
                      <div key={i} className={styles.listItem}>
                        ...
                        <div className={styles.itemActions}>
                          <button onClick={() => editAward(i)} className={styles.editButton}><FiEdit2 /></button>
                          <button onClick={() => deleteAward(i)} className={styles.deleteButton}><FiTrash2 /></button>
                        </div>
                      </div>
                    ))}
                    {formData.awards.length === 0 && <p className={styles.emptyMessage}>No awards added yet</p>}
                  </div>
                </div>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Fluent, Business Professional, Native" 
                          className={styles.formInput} 
                        />
                      </label>
                    </div>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Global Brand Relaunch Campaign" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Fortune 500 Tech Company" 
                        className={styles.formInput} 
                      />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Campaign Director, Project Lead" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        type="text" 
                        placeholder="6 months, Q1 2023 - Q2 2023" 
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <textarea 
                      ...
                      placeholder="• Led cross-functional team of 12 to execute global rebranding strategy
• Increased brand awareness by 78% across target markets
• Generated $5M in new business within first quarter post-launch
• Achieved 150% ROI on $1.5M campaign budget
• Won 3 industry awards for campaign creativity and effectiveness"
                    ...
                    />
                    <div className={styles.characterCount}>
                      {currentProject.results.length}/2000 characters
                    </div>
                  </label>
                  <div className={styles.formActions}>
                    <button 
                      ...
                      onClick={addProject} 
                      className={styles.addButton} 
                      disabled={!currentProject.name || !currentProject.role || !currentProject.results}
                    >
                        ...
                        <div key={i} className={styles.listItem}>
                          <div className={styles.itemContent}>
                            <div className={styles.itemHeader}>
                              ...
                              {proj.client && <span className={styles.itemSubtitle}> for {proj.client}</span>}
                            </div>
                            <div className={styles.itemMeta}>
                          ...
                          <div className={styles.itemActions}>
                            <button onClick={() => editProject(i)} className={styles.editButton} aria-label={`Edit ${proj.name} project`}><FiEdit2 /></button>
                            <button onClick={() => deleteProject(i)} className={styles.deleteButton} aria-label={`Delete ${proj.name} project`}><FiTrash2 /></button>
                          </div>
                        </div>
                      ))}
                    </div>
      ...
      <section className={styles.ctaSection} aria-labelledby="cta-title">
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            <h2 className={styles.ctaTitle} id="cta-title">Ready to Advance Your Marketing Career?</h2>
            ...
            <div className={styles.ctaButtons}>
              ...
              >
                <span className={styles.ctaButtonText}>Create Your Free Marketing Resume Now</span>
                <FiArrowRight className={styles.ctaButtonIcon} />
              </button>
            </div>
            <div className={styles.ctaGuarantee}>
              <FiCheck className={styles.guaranteeIcon} />
              <span className={styles.guaranteeText}>No credit card required • Free forever • Download in minutes • ATS Optimized for Marketing</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.fullPreviewModal} onClick={() => setShowFullPreview(false)}>
          <div className={styles.fullPreviewContent} onClick={(e) => e.stopPropagation()}>
            <div className={styles.fullPreviewHeader}>
              <h3>Full Marketing Resume Preview</h3>
