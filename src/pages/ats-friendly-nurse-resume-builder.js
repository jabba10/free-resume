...
const Resume = ({ 
  ...
  // Nurse-specific testimonials
  const testimonials = [
    {
      quote: "As an ICU nurse, this builder helped me highlight my critical care experience perfectly. Landed interviews at top hospitals!",
      metric: "ICU Position in 3 Weeks",
      name: "Sarah M., RN, BSN",
      role: "Critical Care Nurse",
      facility: "Johns Hopkins Hospital"
    },
    {
      quote: "Perfect for new grad nurses! The templates helped me showcase my clinical rotations and secure my first nursing job.",
      metric: "First Job After NCLEX",
      name: "James K., RN",
      role: "New Graduate Nurse",
      facility: "Mayo Clinic"
    },
    {
      quote: "The ATS optimization for nursing resumes is incredible. Finally got past the screening systems of major hospitals.",
    ...
    {
      quote: "Travel nurses rejoice! This builder creates clean, professional resumes that agencies love. Doubled my contract offers.",
      metric: "Travel Nurse Success",
      name: "David T., RN, CCRN",
      role: "Travel Nurse",
      facility: "Nationwide Contracts"
    },
    {
      quote: "From bedside to management - this tool helped me create an executive nursing resume that got me promoted.",
      metric: "Nurse Manager Promotion",
      name: "Lisa R., DNP, RN",
      role: "Nurse Executive",
      facility: "Massachusetts General"
    },
    {
      quote: "International nurses - this builder understands global nursing standards. Landed my dream job in the US!",
      metric: "International Nurse Success",
      name: "Amina S., RN",
      role: "International Nurse",
      facility: "New York-Presbyterian"
    }
  ];
  ...
  const faqs = [
    {
      question: "Is this nurse resume builder completely free with no hidden costs?",
      answer: "Yes, our nurse resume builder is 100% free with no hidden costs, watermarks, or subscription fees. Create, edit, and download professional nursing resumes in PDF format without any payment required."
    },
    {
      question: "What makes a nursing resume ATS-friendly?",
      answer: "ATS-friendly nursing resumes use proper medical terminology, clear formatting, and relevant keywords that hospital applicant tracking systems recognize. Our templates are optimized for nursing-specific ATS systems used by 95% of healthcare facilities."
    },
    {
      question: "Can I use this for international nursing job applications?",
      answer: "Absolutely! Our builder supports global nursing standards including US, Canada, UK, Australia, EU, and Middle East formats. We include credentials recognition for international nurses migrating to new healthcare systems."
    },
    {
      question: "How many nursing specialty templates are available?",
      answer: "We offer specialized templates for all nursing roles: ICU, ER, OR, Pediatrics, Oncology, Geriatrics, Travel Nursing, Nurse Practitioner, Nurse Educator, and more. All templates are free and ATS-optimized."
    },
    {
      question: "Does it include nursing certifications and licenses formatting?",
      answer: "Yes! We have dedicated sections for nursing licenses (RN, LPN), specialty certifications (ACLS, PALS, BLS, CCRN, etc.), and state board registrations with proper credential formatting."
    },
    {
      question: "Can travel nurses use this builder for agency applications?",
      answer: "Definitely! Our travel nurse templates highlight flexible scheduling, multi-state licensing, and diverse clinical experiences that travel nursing agencies specifically look for in candidates."
    }
  ];
  ...
  const addExperience = createAddFunction('experience', currentExperience, setCurrentExperience, defaultExperience, 
    () => currentExperience.position && currentExperience.facility && currentExperience.startDate);
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(el, {
        ...
        onclone: (doc) => {
          ...
          if (clone) {
            ...
            const positions = clone.querySelectorAll(`.${styles.experienceItem} h3`);
            positions.forEach(title => {
              title.style.fontSize = `${fontSizes.position}pt`;
            });
            
            const facilities = clone.querySelectorAll(`.${styles.facility}`);
            facilities.forEach(facility => {
              facility.style.fontSize = `${fontSizes.facility}pt`;
            });
      ...
      pdf.save(`${formData.fullName || 'nurse_resume'}_resume.pdf`);
    } catch (err) {
  ...
  const NurseTemplate = ({ formData }) => {
    ...
    const clinicalSkills = formData.skills.filter(skill => skill.category === 'Clinical');
    const technicalSkills = formData.skills.filter(skill => skill.category === 'Technical');
    const softSkills = formData.skills.filter(skill => skill.category === 'Soft Skills');

    return (
      <div className={styles.nurseTemplate}>
            ...
            {formData.experience.map((exp, i) => (
              <div key={i} className={styles.experienceItem}>
                <div className={styles.experienceHeader}>
                  <h3 style={{ fontSize: `${fontSizes.position}pt` }}>{exp.position}</h3>
                  <p className={styles.facility} style={{ fontSize: `${fontSizes.facility}pt` }}>
                    {exp.facility}{exp.unit && ` – ${exp.unit}`} | 
                    <span className={styles.date} style={{ fontSize: `${fontSizes.date}pt` }}>
          ...
          <section className={styles.section}>
            ...
            {formData.certifications.map((cert, i) => (
              <div key={i} className={styles.certificationItem} style={{ fontSize: `${fontSizes.certificationText}pt` }}>
                ...
                {cert.credentialNumber && ` (License #: ${cert.credentialNumber})`}
        ...
        {hasSkills && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>CLINICAL SKILLS & COMPETENCIES</h2>
          ...
          <section className={styles.section}>
            ...
            {formData.affiliations.map((aff, i) => (
              <div key={i} className={styles.affiliationItem} style={{ fontSize: `${fontSizes.regularText}pt` }}>
                <strong>{aff.organization}</strong>
                {aff.role && ` – ${aff.role}`}
              </div>
            ))}
          </section>
  ...
  return (
    <div className={styles.resumeBuilder} lang="en-US">
      <Head>
        <title>Free Nurse Resume Builder 2026: ATS-Optimized Nursing Templates</title>
        <meta name="title" content="Free Nurse Resume Builder 2026: ATS-Optimized Nursing Templates" />
              ...
              "@graph": [
                {
                  ...
                  "isPartOf": {
                    ...
                    "publisher": {
                      ...
                      "sameAs": [
                        "https://twitter.com/NurseResumeFree",
                        "https://www.linkedin.com/company/nurse-resume-free",
                        "https://www.facebook.com/NurseResumeFree",
                        "https://www.youtube.com/@NurseResumeFree"
                      ]
                    }
                  },
                  "primaryImageOfPage": {
                  ...
                  "mainEntity": {
                    ...
                    "name": "Nurse Resume Builder - ATS Optimized Nursing Resume Maker",
                    ...
                    "description": "Free online ATS-friendly nurse resume builder for RNs, LPNs, NPs, and nursing professionals worldwide.",
                    "featureList": [
                      "Nursing ATS-Optimized Templates",
                      "Clinical Skills Database",
                      "One-Click PDF Download",
                      "Nursing Experience Formatting",
                ...
                {
                  "@type": "HowTo",
                  "name": "How to Create a Professional Nursing Resume with Our Free Builder",
                  "description": "Step-by-step guide to create an ATS-optimized nursing resume for free",
                  "totalTime": "PT15M",
                  "estimatedCost": {
                    "@type": "MonetaryAmount",
                    "currency": "USD",
                ...
                {
                  "@type": "Service",
                  "serviceType": "Online Nursing Resume Building Service",
                  "provider": {
                    "@type": "Organization",
                  ...
                  "hasOfferCatalog": {
                    "@type": "OfferCatalog",
                    "name": "Free Nursing Resume Building Services",
                    "itemListElement": [
                      {
                        "@type": "Offer",
                        "itemOffered": {
                          "@type": "Service",
                          "name": "Nursing ATS Resume Templates"
                        }
                      },
                      {
                        "@type": "Offer",
                        "itemOffered": {
                          "@type": "Service",
                          "name": "Nursing Resume Editing"
                        }
                      }
                    ]
                  },
                  "description": "Free ATS-friendly nurse resume builder for nursing professionals worldwide",
                  "offers": {
                    "@type": "Offer",
                    "price": "0",
                    "priceCurrency": "USD"
        ...
        <ol>
          <li>
            <Link href="/" className={styles.breadcrumbLink} prefetch={false}>
              ...
              <span className={styles.breadcrumbText}>Nurse Resume Builder</span>
            </Link>
          </li>
          ...
          <li>
            <Link href="/ats-friendly-nurse-resume-builder" className={styles.breadcrumbLink} prefetch={false}>
              <span className={styles.breadcrumbText}>Free Nursing Templates</span>
            </Link>
          </li>
        </ol>
      </nav>
          ...
          <div className={styles.heroContent}>
            <div className={styles.trustBadge}>
              ...
              <span className={styles.trustBadgeText}>
                Rated 4.9/5 by 42365+ Nurses Worldwide | #1 Free Nurse Resume Builder 2026
              </span>
            </div>
            ...
            <p className={styles.heroSubtitle}>
              Create a <strong className={styles.heroHighlight}>professional, ATS-optimized nursing resume for free in minutes.</strong> Our nurse resume builder ensures your clinical experience and nursing credentials get noticed by hospitals and healthcare employers globally.
            </p>
            ...
            <div className={styles.ctaButtons}>
              <button
                ...
                aria-label="Start building your free nurse resume now—no sign-up required"
              >
                <span className={styles.buttonText}>Start Building Your Nurse Resume Now</span>
              ...
              <button
                ...
                aria-label="Download nurse resume as PDF"
                disabled={isGeneratingPDF || !hasContent()}
              >
                <FiDownload className={styles.buttonIcon} />
                <span className={styles.buttonText}>Download Nurse Resume PDF</span>
              </button>
            </div>
            ...
            <div className={styles.heroStats}>
              <div className={styles.statItem}>
                ...
                <span className={styles.statLabel}>Nursing Resumes Created</span>
              </div>
              <div className={styles.statItem}>
              ...
              <div className={styles.statItem}>
                ...
                <span className={styles.statLabel}>Faster Nursing Hires</span>
              </div>
              <div className={styles.statItem}>
                <span className={styles.statNumber}>4.9/5</span>
                <span className={styles.statLabel}>Rating from Nurses</span>
              </div>
            </div>

            <div className={styles.nursingBadges}>
              <div className={styles.badgeGrid}>
                <span className={styles.badgeItem}><FiThermometer /> ICU Nurse</span>
                <span className={styles.badgeItem}><FiDroplet /> ER Nurse</span>
                <span className={styles.badgeItem}><FiUsers /> Pediatric Nurse</span>
                <span className={styles.badgeItem}><FiStethoscope /> Nurse Practitioner</span>
                <span className={styles.badgeItem}><FiGlobe /> Travel Nurse</span>
                <span className={styles.badgeItem}><FiBook /> New Grad Nurse</span>
                <span className={styles.badgeItem}><FiShield /> Oncology Nurse</span>
                <span className={styles.badgeItem}><FiHeart /> Cardiac Nurse</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.resumePreviewCard}>
              <div className={styles.previewContent}>
                <div
                  ...
                  ref={resumeRef}
                >
                  <NurseTemplate formData={formData} />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className={styles.formSectionContent}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    ...
                    <label className={styles.formLabel}>
                      Nursing Credentials
                      <input type="text" name="credentials" value={formData.credentials} onChange={handleCredentialsChange} placeholder="RN, BSN, CCRN" className={styles.formInput} />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Email*
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="sarah.johnson@nursing.com" required className={styles.formInput} />
                    </label>
                    <label className={styles.formLabel}>
                      Phone
                  ...
                  <label className={styles.formLabel}>
                    Location & Licenses
                    <input type="text" name="address" value={formData.address} onChange={handleInputChange} placeholder="New York, NY | RN License: 1234567" className={styles.formInput} />
                  </label>
                </div>
                ...
                <div className={styles.formCard}>
                  <label className={styles.formLabel}>
                    ...
                    <textarea
                      ...
                      placeholder="Compassionate and dedicated Registered Nurse with 8+ years of experience in critical care and emergency settings. Skilled in patient assessment, medication administration, and interdisciplinary collaboration. Proven track record of improving patient outcomes through evidence-based practice and compassionate care. Specialized in trauma nursing with expertise in advanced cardiac life support and emergency response protocols."
                      required
                ...
                <div className={styles.formCard}>
                  ...
                  <div className={styles.socialInput}>
                    ...
                    >
                      ...
                      <option value="NursingAssociation">Nursing Association Profile</option>
                      <option value="Portfolio">Nursing Portfolio</option>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    ...
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        value={currentExperience.facility} 
                        onChange={(e) => setCurrentExperience({ ...currentExperience, facility: e.target.value })} 
                  ...
                  <label className={styles.formLabel}>
                    Unit / Department / Specialty
                    <input 
                      value={currentExperience.unit} 
                      onChange={(e) => setCurrentExperience({ ...currentExperience, unit: e.target.value })} 
                  ...
                  <label className={styles.formLabel}>
                    Nursing Responsibilities & Achievements*
                    <textarea 
...
• Served as preceptor for nursing students and new hires"
                  ...
                  <div className={styles.formActions}>
                    <button 
                      ...
                      className={styles.addButton} 
                      disabled={!currentExperience.position || !currentExperience.facility || !currentExperience.startDate}
                    >
                        ...
                        <div key={i} className={styles.listItem}>
                          <div className={styles.itemContent}>
                            <div className={styles.itemHeader}>
                              ...
                              <span className={styles.itemSubtitle}>at {exp.facility}</span>
                            </div>
                            <div className={styles.itemMeta}>
                              <span>{exp.startDate} – {exp.endDate || 'Present'}</span>
                              {exp.unit && <span>{exp.unit}</span>}
                            </div>
                  ...
                  <div className={styles.fontSizeGrid}>
                    ...
                    <div className={styles.fontSizeControl}>
                      <label className={styles.fontSizeLabel}>
                        ...
                        <span className={styles.fontSizeValue}>{fontSizes.position}pt</span>
                      </label>
                      <input 
                        type="range" 
                        min="6" 
                        max="16" 
                        value={fontSizes.position}
                        onChange={(e) => handleFontSizeChange('position', e.target.value)}
                        className={styles.fontSizeSlider}
                      />
                    </div>
                    ...
                    <div className={styles.fontSizeControl}>
                      <label className={styles.fontSizeLabel}>
                        <span>Facility/Institution Names</span>
        ...
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              Everything you need to know about creating professional nursing resumes with our tool.
            </p>
          </div>
      ...
      <section className={styles.ctaSection} aria-labelledby="cta-title">
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            <h2 className={styles.ctaTitle} id="cta-title">Ready to Advance Your Nursing Career?</h2>
            <p className={styles.ctaSubtitle}>
              Join 2 million+ nurses worldwide who landed their dream jobs with our free ATS-friendly nursing resume builder.
            </p>
            <div className={styles.ctaButtons}>
              <button
                onClick={() => setActiveSection('personal')}
                className={styles.ctaButton}
                aria-label="Create your free nurse resume now—no sign-up required"
              >
                <span className={styles.ctaButtonText}>Create Your Free Nurse Resume Now</span>
                <FiArrowRight className={styles.ctaButtonIcon} />
              </button>
            </div>
            <div className={styles.ctaGuarantee}>
              <FiCheck className={styles.guaranteeIcon} />
              <span className={styles.guaranteeText}>No credit card required • Free forever • Download in minutes • ATS Optimized for Nursing</span>
            </div>
          </div>
        </div>
      </section>
