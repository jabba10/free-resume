...
const SecurityGuardResume = ({ 
  ...
  // Font size state - Professional security font sizing
  ...
  const SecurityGuardTemplate = ({ formData }) => {
    ...
    return (
      <div className={styles.securityTemplate}>
        ...
        {hasSummary && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SECURITY PROFESSIONAL SUMMARY</h2>
        ...
        {hasExperience && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SECURITY EXPERIENCE</h2>
        ...
        {hasSpecialties && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SECURITY SPECIALTIES</h2>
        ...
        {hasLicenses && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SECURITY LICENSES</h2>
        ...
        {hasTrainings && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SECURITY TRAINING</h2>
        ...
        {hasEquipment && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SECURITY EQUIPMENT PROFICIENCY</h2>
            <ul className={styles.skillsList}>
  ...
  return (
    <div className={styles.resumeBuilder} lang="en-US">
      <Head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;600;700;800&family=Open+Sans:wght@400;600;700&display=swap" rel="stylesheet" />
              ...
              "@graph": [
                {
                  ...
                  "mainEntity": {
                    ...
                    "description": "Free online ATS-friendly security guard resume builder for security officers, guards, surveillance operators, and protection specialists.",
                    "featureList": [
                      "Security ATS-Optimized Templates",
                      "Security Content Suggestions",
                      "One-Click PDF Download",
                      "Security Experience Formatting",
      ...
      <nav className={styles.breadcrumb} aria-label="Breadcrumb">
        <ol>
          ...
          <li>
            <Link href="/ats-friendly-security-guard-resume-builder" className={styles.breadcrumbLink} prefetch={false}>
              <span className={styles.breadcrumbText}>Free Security Template</span>
            </Link>
          </li>
        </ol>
      </nav>
        ...
        <div className={styles.container}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Create a <strong className={styles.heroHighlight}>professional, ATS-optimized security guard resume for free in minutes.</strong> Our security resume builder ensures your security experience, licenses, and certifications get noticed by security companies and employers.
            </p>
            ...
            <div className={styles.ctaButtons}>
              ...
              >
                <span className={styles.buttonText}>Start Building Your Security Resume Now</span>
              ...
              >
                ...
                <span className={styles.buttonText}>Download Security Resume PDF</span>
              </button>
            </div>
            ...
            <div className={styles.securityBadges}>
              <div className={styles.badgeGrid}>
                <span className={styles.badgeItem}><FiShield /> Armed Security Guard</span>
                <span className={styles.badgeItem}><FiUsers /> Corporate Security</span>
                <span className={styles.badgeItem}><FiCamera /> Surveillance Operator</span>
                <span className={styles.badgeItem}><FiLock /> Executive Protection</span>
                <span className={styles.badgeItem}><FiVideo /> CCTV Monitoring</span>
                <span className={styles.badgeItem}><FiAlertCircle /> Event Security</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.formSection}>
          <div className={styles.formNavigation}>
            {[
              ...
              { id: 'experience', label: 'Security Experience', icon: <FiShield /> },
          ...
          <div className={styles.formContent}>
            ...
            {activeSection === 'personal' && (
              <div className={styles.formSectionContent}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Full Name*
                      <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} placeholder="John Smith, Security Officer" required className={styles.formInput} />
                    </label>
                    <label className={styles.formLabel}>
                      Email*
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="john.smith@security.com" required className={styles.formInput} />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                ...
                <div className={styles.formCard}>
                  ...
                  <p className={styles.sectionDescription}>Add your professional security profiles (LinkedIn, portfolio, etc.)</p>
            ...
            {activeSection === 'experience' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiShield /> Security Experience</h3>
                <p className={styles.sectionDescription}>List your security positions in reverse chronological order (most recent first)</p>
...
• Reduced unauthorized access incidents by 40% through enhanced monitoring procedures"
                ...
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Your Security Experience</h4>
                  {formData.experience.length === 0 ? (
                    <p className={styles.emptyMessage}>No security experience added yet</p>
                  ) : (
                    <div className={styles.itemsList}>
                      {formData.experience.map((exp, i) => (
                        <div key={i} className={styles.listItem}>
            ...
            {activeSection === 'education' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiBook /> Education & Security Training</h3>
                <p className={styles.sectionDescription}>List your formal education and relevant security training programs</p>
                ...
                <div className={styles.formCard}>
                  ...
                  {formData.education.length === 0 ? (
                    <p className={styles.emptyMessage}>No education/training added yet</p>
                  ) : (
                    <div className={styles.itemsList}>
                      {formData.education.map((edu, i) => (
                        <div key={i} className={styles.listItem}>
            ...
            {activeSection === 'licenses' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiFileText /> Security Licenses & Certifications</h3>
                
                {/* Security Licenses */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}><FiShield /> Security Licenses</h4>
                  <p className={styles.sectionDescription}>Add your state/province/country security licenses</p>
                ...
                <div className={styles.formCard}>
                  ...
                  <p className={styles.sectionDescription}>Add your professional security certifications</p>
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        Certification Name*
            ...
            {activeSection === 'skills' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiActivity /> Skills, Training & Equipment</h3>
                
                {/* Security Specialties */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Security Specialties</h4>
                  <p className={styles.sectionDescription}>List your security specialties and areas of expertise</p>
                  <div className={styles.skillsInput}>
                    <input 
                ...
                {/* Security Training */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}><FiTool /> Security Training</h4>
                  <p className={styles.sectionDescription}>Add your specialized security training programs</p>
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        Training Program*
                  ...
                  <div className={styles.itemsList}>
                    ...
                    {formData.trainings.length === 0 && <p className={styles.emptyMessage}>No training added yet</p>}
                  </div>
                </div>

                {/* Security Equipment Proficiency */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}><FiTool /> Security Equipment Proficiency</h4>
                  <p className={styles.sectionDescription}>List security equipment and systems you're proficient with</p>
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        Equipment/System*
            ...
            {activeSection === 'settings' && (
              <div className={styles.formSectionContent}>
                ...
                <p className={styles.sectionDescription}>Customize font sizes for your security guard resume PDF. All sizes are in points (pt).</p>
      ...
      <section className={styles.ctaSection} aria-labelledby="cta-title">
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            <h3 className={styles.ctaTitle} id="cta-title">Ready to Advance Your Security Career?</h3>
            <p className={styles.ctaSubtitle}>
              Join 2 million+ security professionals who landed their dream jobs with our free ATS-friendly security guard resume builder.
            </p>
            <div className={styles.ctaButtons}>
              <button
                onClick={() => setActiveSection('personal')}
              ...
              >
                <span className={styles.ctaButtonText}>Create Your Free Security Resume Now</span>
                <FiArrowRight className={styles.ctaButtonIcon} />
              </button>
            </div>
            <div className={styles.ctaGuarantee}>
              <FiCheck className={styles.guaranteeIcon} />
              <span className={styles.guaranteeText}>No credit card required • Free forever • Download in minutes • ATS Optimized for Security Industry</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.fullPreviewModal} onClick={() => setShowFullPreview(false)}>
          <div className={styles.fullPreviewContent} onClick={(e) => e.stopPropagation()}>
            <div className={styles.fullPreviewHeader}>
              <h4>Full Security Guard Resume Preview</h4>
