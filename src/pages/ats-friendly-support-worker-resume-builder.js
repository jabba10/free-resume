...
const Resume = ({ 
  ...
  return (
    <div className={styles.resumeBuilder} lang="en-GB">
      <Head>
        <title>Free UK Support Worker CV Builder: DBS-Ready Templates 2026</title>
        <meta name="title" content="Free UK Support Worker CV Builder: DBS-Ready Templates 2026" />
