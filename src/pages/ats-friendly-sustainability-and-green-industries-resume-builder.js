...
const Resume = ({ 
  ...
  const testimonials = [
    {
      quote: "Created my sustainability resume in 10 minutes and landed interviews the same week. The industry-specific templates are incredible!",
      metric: "Found ESG Position in 2 Weeks",
      name: "Sarah M.",
      role: "Sustainability Manager",
      company: "GreenTech Solutions"
    },
    {
      quote: "Finally a resume builder that understands sustainability credentials. The ATS templates helped me pass corporate screening systems.",
    ...
    {
      quote: "As a recent environmental science graduate, the entry-level sustainability templates were perfect. Landed my first green job using this builder.",
    ...
    {
      quote: "The sustainability resume builder saved me - could update my CV between projects. Professional results without the cost.",
    ...
    {
      quote: "Sustainability ATS-friendly templates actually work! Got callbacks from companies that previously ignored my applications.",
    ...
    {
      quote: "Free PDF download with proper sustainability formatting? Unbeatable value. Best green industry resume builder I've found.",
      metric: "Perfect Resume in 15min",
      name: "Lisa R.",
      role: "Sustainability Director",
      company: "EcoInnovate Partners"
    }
  ];
  ...
  const faqs = [
    {
      question: "Is this sustainability resume builder really free with no hidden costs?",
      answer: "Yes, our sustainability resume builder is completely free with no hidden costs or watermarks. Create, edit, and download your professional green industry resume in PDF format without any payment required."
    },
    {
      question: "What does ATS-friendly mean for sustainability resumes?",
      answer: "ATS-friendly means our sustainability resume templates are optimized to pass through Applicant Tracking Systems used by 95% of environmental organizations and green companies. This ensures your sustainability experience and credentials are properly scanned and recognized."
    },
    {
      question: "Can I download my sustainability resume as PDF without creating an account?",
      answer: "Absolutely! Download your professional sustainability resume in PDF format without creating an account. Everything is completely free and accessible immediately for environmental professionals, sustainability managers, and green industry experts."
    },
    {
      question: "How many sustainability resume templates are available for free?",
      answer: "We offer professionally designed ATS-friendly sustainability resume templates for ESG analysts, renewable energy specialists, environmental consultants, climate strategists, and all green industry roles. All templates are completely free and optimized for sustainability hiring."
    },
    {
      question: "How does your sustainability resume builder work?",
      answer: "Our builder uses ATS-optimized sustainability templates with proper environmental terminology formatting. We guide you to highlight sustainability experience, certifications, and specialized skills that green industry employers look for."
    },
    {
      question: "Can I edit my sustainability resume after downloading it?",
      answer: "Yes, you can always come back and edit your sustainability resume. Your work saves automatically, and you can download updated versions as many times as needed—completely free."
    }
  ];
        ...
        onclone: (doc) => {
          ...
          if (clone) {
            ...
            clone.querySelectorAll('*').forEach(n => {
              ...
              n.style.fontFamily = "'Montserrat', 'Helvetica Neue', 'Arial', sans-serif";
            });
          }
        }
      });
  ...
  const SustainabilityTemplate = ({ formData }) => {
    ...
    return (
      <div className={styles.sustainabilityTemplate}>
        ...
        {hasSummary && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SUSTAINABILITY PROFILE</h2>
        ...
        {hasProjects && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SUSTAINABILITY PROJECTS & IMPACT</h2>
            {formData.projects.map((proj, i) => (
              <div key={i} className={styles.projectItem}>
                <h3 style={{ fontSize: `${fontSizes.degree}pt` }}>{proj.name}</h3>
                {proj.description && <p className={styles.projectDescription} style={{ fontSize: `${fontSizes.regularText}pt` }}>{proj.description}</p>}
                {proj.impact && <p className={styles.projectImpact} style={{ fontSize: `${fontSizes.bulletText}pt` }}><strong>Impact:</strong> {proj.impact}</p>}
              </div>
            ))}
          </section>
        )}
        ...
        {hasCertifications && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>CERTIFICATIONS & CREDENTIALS</h2>
  ...
  return (
    <div className={styles.resumeBuilder} lang="en-US">
      <Head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700;800&family=Source+Sans+Pro:wght@300;400;600&display=swap" rel="stylesheet" />
        ...
        <div className={styles.container}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Create a <strong className={styles.heroHighlight}>professional, ATS-optimized sustainability resume for free in minutes.</strong> Our green industry resume builder ensures your environmental impact and ESG credentials get noticed by sustainable companies.
            </p>
            ...
            <div className={styles.ctaButtons}>
              <button
                ...
                aria-label="Start building your free sustainability resume now—no sign-up required"
              >
                <span className={styles.buttonText}>Start Building Your Sustainability Resume Now</span>
              ...
              <button
                ...
                aria-label="Download sustainability resume as PDF"
                disabled={isGeneratingPDF || !hasContent()}
              >
                <FiDownload className={styles.buttonIcon} />
                <span className={styles.buttonText}>Download Sustainability Resume PDF</span>
              </button>
            </div>
            ...
            <div className={styles.industryBadges}>
              <div className={styles.badgeGrid}>
                ...
                <span className={styles.badgeItem}><FiAnchor /> ESG & Sustainability</span>
                <span className={styles.badgeItem}><FiWind /> Climate Strategy</span>
                <span className={styles.badgeItem}><FiRefreshCw /> Circular Economy</span>
                <span className={styles.badgeItem}><FiDroplet /> Water Management</span>
                <span className={styles.badgeItem}><FiZap /> Clean Technology</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.resumePreviewCard}>
              <div className={styles.previewContent}>
                <div
                  ...
                  ref={resumeRef}
                >
                  <SustainabilityTemplate formData={formData} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.formSection}>
          <div className={styles.formNavigation}>
            {[
              ...
              { id: 'expertise', label: 'Expertise', icon: <FiActivity /> },
          ...
          <div className={styles.formContent}>
            ...
            {activeSection === 'personal' && (
              <div className={styles.formSectionContent}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Full Name*
                      <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} placeholder="Alex Green, LEED AP" required className={styles.formInput} />
                    </label>
                    <label className={styles.formLabel}>
                      Email*
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="alex.green@sustainability.com" required className={styles.formInput} />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                ...
                <div className={styles.formCard}>
                  <label className={styles.formLabel}>
                    Sustainability Profile & Career Summary*
                    <textarea
                      name="summary"
                      value={formData.summary}
                      onChange={handleInputChange}
                      placeholder="Passionate sustainability professional with 8+ years of experience in renewable energy project management and ESG strategy development. Proven track record of implementing circular economy solutions that reduce carbon footprint by 40%+. Skilled in stakeholder engagement, sustainability reporting, and driving environmental innovation across diverse industries. Committed to advancing climate action through data-driven solutions and collaborative partnerships."
                      required
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Sustainability Manager, ESG Analyst, Renewable Energy Specialist" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="GreenTech Solutions, Environmental NGO, Sustainable Corp" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <input 
                      ...
                      placeholder="Environmental Strategy / Renewable Energy Division" 
                      className={styles.formInput} 
                    />
                  </label>
                  <div className={styles.formGroup}>
                  ...
                  <label className={styles.formLabel}>
                    Key Responsibilities & Sustainability Impact*
                    <textarea 
                      value={currentExperience.description} 
                      onChange={(e) => setCurrentExperience({ ...currentExperience, description: e.target.value })} 
                      placeholder="• Developed and implemented corporate sustainability strategy reducing carbon emissions by 35%
• Managed renewable energy projects generating 2.5 MW of clean power annually
• Led ESG reporting aligned with GRI and SASB standards
• Collaborated with cross-functional teams to integrate circular economy principles
• Secured $1.2M in green financing for sustainability initiatives"
                      required 
                      className={styles.formTextarea} 
                      rows="8" 
                    />
                ...
                <div className={styles.formCard}>
                  <label className={styles.formLabel}>
                    ...
                    <input 
                      ...
                      placeholder="Corporate Carbon Neutrality Initiative, Community Solar Program" 
                      required 
                      className={styles.formInput} 
                    />
                  </label>
                  <label className={styles.formLabel}>
                    ...
                    <textarea 
                      ...
                      placeholder="Description of the project, your role, and key activities" 
                      className={styles.formTextarea} 
                      rows="4" 
                    />
                  </label>
                  <label className={styles.formLabel}>
                    ...
                    <input 
                      ...
                      placeholder="Reduced carbon emissions by 500 tons annually, Achieved 40% waste reduction" 
                      required 
                      className={styles.formInput} 
                    />
                  </label>
                  <div className={styles.formActions}>
                    <button 
                      ...
                      onClick={addProject} 
                      className={styles.addButton} 
                      disabled={!currentProject.name.trim() || !currentProject.impact.trim()}
                    >
                      ...
                      {formData.projects.map((proj, i) => (
                        <div key={i} className={styles.listItem}>
                          <div className={styles.itemContent}>
                            ...
                            {proj.description && <div className={styles.itemDescription}>{proj.description}</div>}
                            {proj.impact && <div className={styles.itemImpact}><strong>Impact:</strong> {proj.impact}</div>}
                          </div>
                          <div className={styles.itemActions}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    ...
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Master of Environmental Science, Bachelor of Sustainability" 
                        required 
                        className={styles.formInput} 
                      />
                    </label>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <input 
                      ...
                      placeholder="Environmental Policy, Renewable Energy Systems, Sustainable Business" 
                      className={styles.formInput} 
                    />
                  </label>
                  <div className={styles.formGroup}>
                ...
                <div className={styles.formCard}>
                  ...
                  <div className={styles.skillsInput}>
                    <input 
                      ...
                      placeholder="Carbon Accounting, ESG Reporting, Renewable Energy, Circular Economy" 
                      className={styles.formInput} 
                    />
                    <div className={styles.formActions}>
                      <button 
                  ...
                  <div className={styles.itemsList}>
                    ...
                    {formData.specialties.length === 0 && <p className={styles.emptyMessage}>No expertise areas added yet</p>}
                  </div>
                </div>
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="LEED AP, GRI Certified, SASB FSA, TRUE Advisor" 
                          className={styles.formInput} 
                        />
                      </label>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="USGBC, GRI, SASB, Green Business Certification Inc." 
                          className={styles.formInput} 
                        />
                      </label>
                    </div>
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="International Society of Sustainability Professionals (ISSP)" 
                          className={styles.formInput} 
                        />
                      </label>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Active Member, Board Member, Committee Chair" 
                          className={styles.formInput} 
                        />
                      </label>
                    </div>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Fluent, Professional Working Proficiency" 
                          className={styles.formInput} 
                        />
                      </label>
                    </div>
        ...
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              Everything you need to know about creating professional sustainability resumes with our tool.
            </p>
          </div>
      ...
      <section className={styles.ctaSection} aria-labelledby="cta-title">
        <div className={styles.container}>
          <div className={styles.ctaContent}>
            <h2 className={styles.ctaTitle} id="cta-title">Ready to Advance Your Sustainability Career?</h2>
            <p className={styles.ctaSubtitle}>
              Join 500,000+ sustainability professionals who landed their dream green jobs with our free ATS-friendly sustainability resume builder.
            </p>
            <div className={styles.ctaButtons}>
              <button
                onClick={() => setActiveSection('personal')}
                className={styles.ctaButton}
                aria-label="Create your free sustainability resume now—no sign-up required"
              >
                <span className={styles.ctaButtonText}>Create Your Free Sustainability Resume Now</span>
                <FiArrowRight className={styles.ctaButtonIcon} />
              </button>
            </div>
            <div className={styles.ctaGuarantee}>
              <FiCheck className={styles.guaranteeIcon} />
              <span className={styles.guaranteeText}>No credit card required • Free forever • Download in minutes • ATS Optimized for Green Industries</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.fullPreviewModal} onClick={() => setShowFullPreview(false)}>
          <div className={styles.fullPreviewContent} onClick={(e) => e.stopPropagation()}>
            <div className={styles.fullPreviewHeader}>
              <h3>Full Sustainability Resume Preview</h3>
