...
const sustainabilityResumeStyles = `
  ...
  * { box-sizing: border-box; }
  ...
  .cf-sustainability-template { color: #000000; line-height: 1.25; height: 100%; }
  ...
  .cf-project-description { margin: 3pt 0; }
  .cf-project-impact { margin: 3pt 0; }
  ...
  .cf-item-impact { margin-top: 4px; color: var(--cf-primary); font-size: 13px; }
  ...
  .cf-modal-page .cf-sustainability-template { width: 100%; height: 100%; padding: 10mm 15mm; box-sizing: border-box; overflow-y: auto; }
  ...
  @media (max-width: 768px) {
    ...
    .cf-modal-page .cf-sustainability-template { padding: 8mm 12mm; }
  ...
  @media print {
    ...
    .cf-sustainability-template, .cf-section { page-break-inside: avoid; }
  }
`;
...
const Resume = ({ seoData, buildTimestamp }) => {
  ...
  const defaultProject = () => ({ name: '', description: '', impact: '', isEditing: false, editIndex: null });
  ...
  const [formData, setFormData] = useState({ fullName: '', email: '', phone: '', address: '', summary: '', experience: [], education: [], specialties: [], certifications: [], affiliations: [], projects: [], languages: [], socialLinks: [] });
  ...
  const addProject = createAddFunction('projects', currentProject, setCurrentProject, defaultProject, () => currentProject.name.trim() && currentProject.impact.trim());
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      pdf.save(`${formData.fullName || 'sustainability_resume'}_resume.pdf`);
      setShowSharePopup(true);
    } catch (err) { console.error("PDF Error:", err); alert("Failed to generate PDF."); }
    finally { setIsGeneratingPDF(false); }
  };

  const SustainabilityTemplate = ({ formData }) => {
    ...
    return (
      <div className="cf-sustainability-template">
        ...
        {hasSummary && <section className="cf-section"><h2 className="cf-section-title" style={{ fontSize: `${fontSizes.sectionTitle}pt`, fontWeight: 700 }}>SUSTAINABILITY PROFILE</h2><p className="cf-summary-text" style={{ fontSize: `${fontSizes.regularText}pt`, fontWeight: 400 }}>{formData.summary}</p></section>}
        ...
        {hasProjects && <section className="cf-section"><h2 className="cf-section-title" style={{ fontSize: `${fontSizes.sectionTitle}pt`, fontWeight: 700 }}>SUSTAINABILITY PROJECTS & IMPACT</h2>{formData.projects.map((proj, i) => (<div key={i} className="cf-project-item"><h3 style={{ fontSize: `${fontSizes.degree}pt`, fontWeight: 700 }}>{proj.name}</h3>{proj.description && <p className="cf-project-description" style={{ fontSize: `${fontSizes.regularText}pt`, fontWeight: 400 }}>{proj.description}</p>}{proj.impact && <p className="cf-project-impact" style={{ fontSize: `${fontSizes.bulletText}pt`, fontWeight: 400 }}><strong style={{ fontWeight: 700 }}>Impact:</strong> {proj.impact}</p>}</div>))}</section>}
  ...
  const canonicalUrl = "https://professionalresumefree.com/ats-friendly-sustainability-and-green-industries-resume-builder";
    ...
    <>
      ...
      <div className="cf-resume-builder" lang="en-US">
        <Head>
          ...
          <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon-green.png" />
          <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32-green.png" />
          <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16-green.png" />
          <link rel="manifest" href="/site-green.webmanifest" />
                ...
                "@graph": [
                  {
                    ...
                    "isPartOf": {
                      ...
                      "publisher": {
                        ...
                        "sameAs": [
                          "https://twitter.com/GreenResumeFree",
                          "https://www.linkedin.com/company/sustainability-resume-free",
                          "https://www.facebook.com/SustainabilityResumeFree",
                          "https://www.youtube.com/@SustainabilityResumeFree"
                        ]
                      }
                    },
                    "primaryImageOfPage": {
                    ...
                    "mainEntity": {
                      ...
                      "description": "Free online ATS-friendly sustainability resume builder for environmental professionals, ESG analysts, renewable energy specialists, and climate strategists.",
                      "featureList": [
                        "Sustainability ATS-Optimized Templates",
                        "ESG & Green Industry Content Suggestions",
                        "One-Click PDF Download",
                        "Environmental Impact Formatting",
                  ...
                  {
                    "@type": "HowTo",
                    "name": "How to Create a Professional Sustainability Resume with Our Free Builder",
                    "description": "Step-by-step guide to create an ATS-optimized sustainability resume for free",
                    "totalTime": "PT15M",
                    "estimatedCost": {
                      "@type": "MonetaryAmount",
                      "currency": "USD",
                    ...
                    "step": [
                      ...
                      },
                      {
                        ...
                        "text": "Export your professional sustainability resume as PDF - completely free, no watermarks.",
                  ...
                  {
                    "@type": "Service",
                    "serviceType": "Online Sustainability Resume Building Service",
                    "provider": {
                      "@type": "Organization",
                      "name": "Professional Sustainability Resume Free",
                      "url": "https://professionalresumefree.com",
                    ...
                    "hasOfferCatalog": {
                      "@type": "OfferCatalog",
                      "name": "Free Sustainability Resume Building Services",
                      "itemListElement": [
                        {
                          "@type": "Offer",
                          "itemOffered": {
                            "@type": "Service",
                            "name": "Sustainability ATS Resume Templates"
                          }
                        },
                        {
                          "@type": "Offer",
                          "itemOffered": {
                            "@type": "Service",
                            "name": "ESG Resume Editing"
                          }
                        }
                      ]
                    },
                    "description": "Free ATS-friendly sustainability resume builder for environmental professionals worldwide",
                    "offers": {
                      "@type": "Offer",
                      "price": "0",
                      "priceCurrency": "USD"
            ...
            <div className="cf-hero-content">
              ...
              <div className="cf-cta-buttons">
                <button onClick={() => setActiveSection('personal')} className="cf-btn-primary" aria-label="Start building your free sustainability resume now—no sign-up required">
                  <span className="cf-btn-text">Start Building Your Sustainability Resume Now</span>
        ...
        <div className="cf-layout">
          <div className="cf-preview-section">
            ...
            <div className={`cf-preview-container ${showFullPreview ? 'cf-full-preview' : ''}`}><div className="cf-resume-card"><div className="cf-preview-content"><div className="cf-resume-preview" ref={resumeRef}><SustainabilityTemplate formData={formData}/></div></div></div></div>
          </div>
          <div className="cf-form-section">
            <div className="cf-form-nav">
              {[{id:'personal',label:'Personal',icon:<FiUser/>},{id:'experience',label:'Experience',icon:<FiBriefcase/>},{id:'projects',label:'Projects',icon:<FiTarget/>},{id:'education',label:'Education',icon:<FiBook/>},{id:'expertise',label:'Expertise',icon:<FiActivity/>},{id:'settings',label:'Font Settings',icon:<FiSettings/>}].map(item => (<button key={item.id} className={`cf-nav-btn ${activeSection===item.id?'cf-nav-btn-active':''}`} onClick={()=>setActiveSection(item.id)}>{item.icon}<span>{item.label}</span></button>))}
            </div>
            <div className="cf-form-content">
              {activeSection==='personal'&&(
                <div className="cf-form-section-content">
                  ...
                  <div className="cf-form-card">
                    <div className="cf-form-group"><label className="cf-form-label">Full Name*<input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} placeholder="Alex Green, LEED AP" required className="cf-form-input"/></label><label className="cf-form-label">Email*<input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="alex.green@sustainability.com" required className="cf-form-input"/></label></div>
                  ...
                  <div className="cf-form-card"><label className="cf-form-label">Sustainability Profile & Career Summary*<textarea name="summary" value={formData.summary} onChange={handleInputChange} placeholder="Passionate sustainability professional with 8+ years..." required className="cf-form-textarea" rows="6"/><div className="cf-char-count">{formData.summary.length}/500 characters</div></label></div>
                  <div className="cf-form-card">
                    <h4 className="cf-sub-section-title"><FiGlobe/> Professional Links</h4><p className="cf-section-desc">Add your professional sustainability profiles</p>
              ...
              {activeSection==='experience'&&(
                <div className="cf-form-section-content">
                  ...
                  <p className="cf-section-desc">List your sustainability roles in reverse chronological order (most recent first)</p>
                  <div className="cf-form-card">
                    <div className="cf-form-group"><label className="cf-form-label">Position Title*<input value={currentExperience.position} onChange={e=>setCurrentExperience({...currentExperience,position:e.target.value})} placeholder="Sustainability Manager, ESG Analyst" required className="cf-form-input"/></label><label className="cf-form-label">Organization/Company*<input value={currentExperience.employer} onChange={e=>setCurrentExperience({...currentExperience,employer:e.target.value})} placeholder="GreenTech Solutions" required className="cf-form-input"/></label></div>
                    <label className="cf-form-label">Department / Focus Area<input value={currentExperience.department} onChange={e=>setCurrentExperience({...currentExperience,department:e.target.value})} placeholder="Environmental Strategy / Renewable Energy" className="cf-form-input"/></label>
                    ...
                    <label className="cf-form-label">Key Responsibilities & Sustainability Impact*<textarea value={currentExperience.description} onChange={e=>setCurrentExperience({...currentExperience,description:e.target.value})} placeholder="• Developed corporate sustainability strategy..." required className="cf-form-textarea" rows="8"/><div className="cf-char-count">{currentExperience.description.length}/2000 characters</div></label>
              ...
              {activeSection==='projects'&&(
                <div className="cf-form-section-content">
                  <h3 className="cf-form-section-title"><FiTarget/> Sustainability Projects</h3>
                  <p className="cf-section-desc">Highlight key sustainability projects with measurable impact</p>
                  <div className="cf-form-card">
                    <label className="cf-form-label">Project Name*<input value={currentProject.name} onChange={e=>setCurrentProject({...currentProject,name:e.target.value})} placeholder="Corporate Carbon Neutrality Initiative" required className="cf-form-input"/></label>
                    <label className="cf-form-label">Project Description<textarea value={currentProject.description} onChange={e=>setCurrentProject({...currentProject,description:e.target.value})} placeholder="Description of the project, your role, and key activities" className="cf-form-textarea" rows="4"/></label>
                    <label className="cf-form-label">Measurable Impact*<input value={currentProject.impact} onChange={e=>setCurrentProject({...currentProject,impact:e.target.value})} placeholder="Reduced carbon emissions by 500 tons annually" required className="cf-form-input"/></label>
                    <div className="cf-form-actions"><button onClick={addProject} className="cf-add-btn" disabled={!currentProject.name.trim()||!currentProject.impact.trim()}><FiPlus/> {currentProject.isEditing?'Update Project':'Add Project'}</button>{currentProject.isEditing&&<button onClick={()=>setCurrentProject(defaultProject())} className="cf-cancel-btn"><FiX/> Cancel</button>}</div>
                  </div>
                  <div className="cf-form-card"><h4 className="cf-sub-section-title">Your Sustainability Projects</h4>{formData.projects.length===0?<p className="cf-empty-msg">No projects added yet</p>:<div className="cf-items-list">{formData.projects.map((proj,i)=>(<div key={i} className="cf-list-item"><div className="cf-item-content"><div className="cf-item-header"><strong className="cf-item-title">{proj.name}</strong></div>{proj.description&&<div className="cf-item-desc">{proj.description}</div>}{proj.impact&&<div className="cf-item-impact"><strong>Impact:</strong> {proj.impact}</div>}</div><div className="cf-item-actions"><button onClick={()=>editProject(i)} className="cf-edit-btn"><FiEdit2/></button><button onClick={()=>deleteProject(i)} className="cf-delete-btn"><FiTrash2/></button></div></div>))}</div>}</div>
                </div>
              )}
              {activeSection==='education'&&(
                <div className="cf-form-section-content">
                  <h3 className="cf-form-section-title"><FiBook/> Education & Training</h3>
                  <p className="cf-section-desc">List your environmental education, degrees, and relevant training</p>
                  <div className="cf-form-card">
                    <div className="cf-form-group"><label className="cf-form-label">Institution*<input value={currentEducation.institution} onChange={e=>setCurrentEducation({...currentEducation,institution:e.target.value})} placeholder="University of California, Berkeley" required className="cf-form-input"/></label><label className="cf-form-label">Degree/Certification*<input value={currentEducation.degree} onChange={e=>setCurrentEducation({...currentEducation,degree:e.target.value})} placeholder="Master of Environmental Science" required className="cf-form-input"/></label></div>
                    <label className="cf-form-label">Program / Specialization<input value={currentEducation.program} onChange={e=>setCurrentEducation({...currentEducation,program:e.target.value})} placeholder="Environmental Policy, Renewable Energy" className="cf-form-input"/></label>
              ...
              {activeSection==='expertise'&&(
                <div className="cf-form-section-content">
                  <h3 className="cf-form-section-title"><FiActivity/> Sustainability Expertise & Credentials</h3>
                  <div className="cf-form-card">
                    <h4 className="cf-sub-section-title">Areas of Sustainability Expertise</h4><p className="cf-section-desc">List your sustainability specialties and areas of expertise</p>
                    <div className="cf-skills-input">
                      <input value={currentSpecialty.name} onChange={e=>setCurrentSpecialty({...currentSpecialty,name:e.target.value})} placeholder="Carbon Accounting, ESG Reporting, Renewable Energy" className="cf-form-input"/>
                    ...
                    <div className="cf-items-list">{formData.specialties.map((s,i)=>(<div key={i} className="cf-list-item"><span>{s.name}</span><div className="cf-item-actions"><button onClick={()=>editSpecialty(i)} className="cf-edit-btn"><FiEdit2/></button><button onClick={()=>deleteSpecialty(i)} className="cf-delete-btn"><FiTrash2/></button></div></div>))}{formData.specialties.length===0&&<p className="cf-empty-msg">No expertise areas added yet</p>}</div>
                  </div>
                  <div className="cf-form-card">
                    <h4 className="cf-sub-section-title"><FiShield/> Sustainability Certifications & Credentials</h4><p className="cf-section-desc">Add your professional sustainability certifications</p>
                    <div className="cf-skills-input">
                      <div className="cf-form-group"><label className="cf-form-label">Certification Name*<input value={currentCertification.name} onChange={e=>setCurrentCertification({...currentCertification,name:e.target.value})} placeholder="LEED AP, GRI Certified" className="cf-form-input"/></label><label className="cf-form-label">Issuing Authority<input value={currentCertification.issuingAuthority} onChange={e=>setCurrentCertification({...currentCertification,issuingAuthority:e.target.value})} placeholder="USGBC, GRI" className="cf-form-input"/></label></div>
                      <div className="cf-form-group"><label className="cf-form-label">Certification Number<input value={currentCertification.certificationNumber} onChange={e=>setCurrentCertification({...currentCertification,certificationNumber:e.target.value})} placeholder="LEED-123456" className="cf-form-input"/></label><label className="cf-form-label">Expiry Date<input value={currentCertification.expiryDate} onChange={e=>setCurrentCertification({...currentCertification,expiryDate:e.target.value})} placeholder="Month Year" className="cf-form-input"/></label></div>
                  ...
                  <div className="cf-form-card">
                    <h4 className="cf-sub-section-title">Professional Affiliations</h4><p className="cf-section-desc">Add your professional sustainability organization memberships</p>
                    <div className="cf-skills-input">
                      <div className="cf-form-group"><label className="cf-form-label">Organization*<input value={currentAffiliation.organization} onChange={e=>setCurrentAffiliation({...currentAffiliation,organization:e.target.value})} placeholder="International Society of Sustainability Professionals" className="cf-form-input"/></label><label className="cf-form-label">Role / Membership Type<input value={currentAffiliation.role} onChange={e=>setCurrentAffiliation({...currentAffiliation,role:e.target.value})} placeholder="Active Member" className="cf-form-input"/></label></div>
                  ...
                  <div className="cf-form-card">
                    ...
                    <div className="cf-skills-input">
                      <div className="cf-form-group"><label className="cf-form-label">Language*<input value={currentLanguage.name} onChange={e=>setCurrentLanguage({...currentLanguage,name:e.target.value})} placeholder="Spanish" className="cf-form-input"/></label><label className="cf-form-label">Proficiency Level<input value={currentLanguage.proficiency} onChange={e=>setCurrentLanguage({...currentLanguage,proficiency:e.target.value})} placeholder="Fluent, Professional Working Proficiency" className="cf-form-input"/></label></div>
