...
const Resume = ({ 
  ...
  const testimonials = [
    {
      quote: "Created my software engineering resume in 10 minutes and landed interviews at FAANG companies. The tech-specific templates are exactly what tech recruiters look for!",
    ...
    {
      quote: "Finally a resume builder that understands tech credentials. The ATS templates helped me pass through automated systems used by top tech companies.",
      metric: "5 Tech Interviews in 2 Weeks",
      name: "Sarah K.",
      role: "Frontend Developer",
      company: "Meta"
    },
    {
      quote: "As a recent computer science graduate, the entry-level templates were perfect. Landed my first software engineering job at Amazon using this builder.",
      metric: "First SWE Job at Amazon",
      name: "Michael P.",
      role: "Software Development Engineer",
      company: "Amazon"
    },
    {
      quote: "The tech resume builder saved my career transition from non-tech background. Could highlight my coding projects effectively.",
      metric: "Career Switch to Tech",
      name: "Jennifer L.",
      role: "Data Scientist",
      company: "Microsoft"
    },
    {
      quote: "Tech ATS-friendly templates actually work! Got callbacks from top startups that previously ignored my applications.",
    ...
    {
      quote: "Free PDF download with proper tech formatting? Unbeatable value. Best tech resume builder I've found for Silicon Valley.",
  ...
  const faqs = [
    {
      ...
      answer: "Yes, our tech resume builder is completely free with no hidden costs or watermarks. Create, edit, and download your professional tech resume in PDF format without any payment required."
    },
    {
      question: "What does ATS-friendly mean for tech resumes?",
      answer: "ATS-friendly means our tech resume templates are optimized to pass through Applicant Tracking Systems used by 99% of tech companies and startups. This ensures your technical skills, projects, and experience are properly scanned and recognized."
    },
    {
      question: "Can I download my tech resume as PDF without creating an account?",
      answer: "Absolutely! Download your professional tech resume in PDF format without creating an account. Everything is completely free and accessible immediately for software engineers, developers, and tech professionals."
    },
    {
      question: "How many tech resume templates are available for free?",
      answer: "We offer professionally designed ATS-friendly tech resume templates for software engineering, data science, product management, UX/UI design, DevOps, and all tech specialties. All templates are completely free and optimized for tech hiring."
    },
    {
      question: "How does your tech resume builder work?",
      answer: "Our builder uses ATS-optimized tech templates with proper technical terminology formatting. We guide you to highlight coding projects, technical skills, GitHub contributions, and specialized expertise that tech employers look for."
    },
    {
      question: "Can I edit my tech resume after downloading it?",
      answer: "Yes, you can always come back and edit your tech resume. Your work saves automatically, and you can download updated versions as many times as needed—completely free."
    }
  ];
            ...
            {formData.projects.map((project, i) => (
              <div key={i} className={styles.projectItem}>
                ...
                <p className={styles.projectDescription} style={{ fontSize: `${fontSizes.regularText}pt` }}>
                  {project.description}
                  {project.technologies && <span className={styles.projectTech}> | Tech: {project.technologies}</span>}
                </p>
                {project.url && (
                  <p className={styles.projectLink} style={{ fontSize: `${fontSizes.regularText}pt` }}>
                    URL: {formatSocialUrl(project.url)}
                  </p>
                )}
              </div>
            ))}
    ...
    <div className={styles.resumeBuilder} lang="en-US">
      ...
      <nav className={styles.breadcrumb} aria-label="Breadcrumb">
        <ol>
          ...
          <li>
            <Link href="/ats-friendly-tech-resume-builder" className={styles.breadcrumbLink} prefetch={false}>
          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.techBadges}>
              <div className={styles.badgeGrid}>
                <span className={styles.badgeItem}><FiCode /> Software Engineering</span>
                <span className={styles.badgeItem}><FiDatabase /> Data Science</span>
                <span className={styles.badgeItem}><FiCpu /> DevOps</span>
                <span className={styles.badgeItem}><FiCloud /> Cloud Engineering</span>
                <span className={styles.badgeItem}><FiTrendingUp /> Product Management</span>
                <span className={styles.badgeItem}><FiServer /> Cybersecurity</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.formSection}>
          <div className={styles.formNavigation}>
            {[
              ...
              { id: 'experience', label: 'Tech Experience', icon: <FiBriefcase /> },
          ...
          <div className={styles.formContent}>
            ...
            {activeSection === 'personal' && (
              <div className={styles.formSectionContent}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      Full Name*
                      <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} placeholder="Alex Johnson, Senior Software Engineer" required className={styles.formInput} />
                    </label>
                    <label className={styles.formLabel}>
                      Email*
                      <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="alex.johnson@tech.com" required className={styles.formInput} />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                    ...
                    <label className={styles.formLabel}>
                      Location
                      <input type="text" name="address" value={formData.address} onChange={handleInputChange} placeholder="San Francisco, CA or Remote" className={styles.formInput} />
                    </label>
                  </div>
                </div>
                ...
                <div className={styles.formCard}>
                  <label className={styles.formLabel}>
                    Professional Tech Summary*
                    <textarea
                      name="summary"
                      value={formData.summary}
                      onChange={handleInputChange}
                      placeholder="Senior Software Engineer with 8+ years of experience building scalable web applications and distributed systems. Specialized in full-stack development with React, Node.js, and cloud technologies. Proven track record of leading engineering teams and delivering high-impact projects that improve system performance by 40%. Passionate about clean code, test-driven development, and mentoring junior engineers."
                      required
            ...
            {activeSection === 'experience' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiBriefcase /> Tech Experience</h3>
                <p className={styles.sectionDescription}>List your tech positions in reverse chronological order (most recent first)</p>
                ...
                <div className={styles.formCard}>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <input 
                      ...
                      placeholder="Cloud Infrastructure Team, Search Algorithms, Payments Platform" 
                      className={styles.formInput} 
                    />
                  </label>
                  <div className={styles.formGroup}>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <textarea 
                      ...
                      placeholder="• Led development of microservices architecture using Node.js and React, reducing API response time by 60%
• Implemented automated testing pipeline that increased code coverage from 65% to 95%
• Mentored 3 junior engineers through code reviews and pair programming sessions
• Optimized database queries reducing server costs by $15K monthly
• Deployed containerized applications using Docker and Kubernetes on AWS"
                ...
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Your Tech Experience</h4>
                  {formData.experience.length === 0 ? (
                    <p className={styles.emptyMessage}>No tech experience added yet</p>
                  ) : (
                    <div className={styles.itemsList}>
                      {formData.experience.map((exp, i) => (
                        <div key={i} className={styles.listItem}>
            ...
            {activeSection === 'education' && (
              <div className={styles.formSectionContent}>
                ...
                <p className={styles.sectionDescription}>List your education, degrees, and relevant tech qualifications</p>
                ...
                <div className={styles.formCard}>
                  ...
                  <label className={styles.formLabel}>
                    Program / Concentration / Specialization
                    <input 
                ...
                {/* Certifications */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}><FiShield /> Tech Certifications</h4>
                  <p className={styles.sectionDescription}>Add your professional tech certifications</p>
            ...
            {activeSection === 'skills' && (
              <div className={styles.formSectionContent}>
                ...
                {/* Technical Skills */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Programming Languages & Technologies</h4>
                  <p className={styles.sectionDescription}>List your technical skills with proficiency levels</p>
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        Skill/Technology*
            ...
            {activeSection === 'projects' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiCpu /> Technical Projects</h3>
                <p className={styles.sectionDescription}>Showcase your coding projects, open-source contributions, and technical initiatives</p>
                ...
                <div className={styles.formCard}>
                  ...
                  <label className={styles.formLabel}>
                    ...
                    <textarea 
                      ...
                      placeholder="• Built full-stack e-commerce platform with microservices architecture
• Implemented real-time inventory management system using WebSockets
• Created RESTful APIs with Node.js and Express, handling 10K+ requests daily
• Deployed using Docker containers orchestrated by Kubernetes on AWS
• Reduced page load time by 40% through code splitting and caching strategies"
                    ...
                    />
                    <div className={styles.characterCount}>
                      {currentProject.description.length}/2000 characters
                    </div>
                  </label>
                  <div className={styles.formActions}>
                    <button 
                ...
                <div className={styles.formCard}>
                  ...
                  {formData.projects.length === 0 ? (
                    <p className={styles.emptyMessage}>No technical projects added yet</p>
                  ) : (
                    <div className={styles.itemsList}>
                      {formData.projects.map((project, i) => (
                        <div key={i} className={styles.listItem}>
                          <div className={styles.itemContent}>
                            <div className={styles.itemHeader}>
                              ...
                              {project.url && (
                                <a href={project.url} target="_blank" rel="noopener noreferrer" className={styles.itemSubtitle}>
                                  View Project →
                                </a>
                              )}
                            </div>
