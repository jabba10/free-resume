...
const ResumeTwo = () => {
  ...
  const ModernTemplate = ({ formData, pageData, pageNumber, totalPages }) => {
        ...
        {pageNumber === 1 && (
          <div className={styles.modernHeader}>
            ...
            <div className={styles.headerContent}>
              <h1 className={styles.modernName}>{formData.fullName || 'Your Name'}</h1>
          ...
          {hasSummary && (
            <section className={styles.modernSection}>
              ...
              <div className={styles.sectionContent}>
                <p className={styles.modernSummary}>{formData.summary}</p>
              </div>
            </section>
          )}
                  ...
                  <div className={styles.sectionContent}>
                    {pageData.experience.map((exp, index) => (
                      <div key={index} className={styles.experienceCard}>
                        ...
                        <ul className={styles.modernBulletList}>
  ...
  const renderTemplate = (pageNumber) => {
    const pageData = getDataByPage(pageNumber);
    return <ModernTemplate formData={formData} pageData={pageData} pageNumber={pageNumber} totalPages={totalPages} />;
  };
  ...
  return (
    <div className={styles.resumeBuilder}>
      <Head>
        <title>Modern Resume Builder | Professional CV Creator</title>
        <meta name="description" content="Create modern, professional resumes with our sleek resume builder. Download as PDF and impress employers." />
        <meta name="keywords" content="modern resume, professional cv, resume builder, pdf resume, job application" />
      </Head>
