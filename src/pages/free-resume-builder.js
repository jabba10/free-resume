...
const Resume = ({ 
  ...
  // Industry categories for skills
  ...
  const faqs = [
    {
      ...
      answer: "Yes, our resume builder is completely free with no hidden costs or watermarks. Create, edit, and download your professional resume in PDF format without any payment required."
    },
    {
      question: "What does ATS-friendly mean for resumes?",
      answer: "ATS-friendly means our resume templates are optimized to pass through Applicant Tracking Systems used by 95% of companies. This ensures your experience and skills are properly scanned and recognized."
    },
    {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(el, {
        ...
        onclone: (doc) => {
          ...
          if (clone) {
            ...
            const professionalTitle = clone.querySelector(`.${styles.professionalTitle}`);
            if (professionalTitle) professionalTitle.style.fontSize = `${fontSizes.professionalTitle}pt`;
      ...
      pdf.save(`${formData.fullName || 'professional_resume'}_resume.pdf`);
    } catch (err) {
  ...
  // --- Resume Template ---
  const UniversalTemplate = ({ formData }) => {
      ...
      <div className={styles.universalTemplate}>
        <header className={styles.resumeHeader}>
          ...
          {formData.professionalTitle && (
            <h2 className={styles.professionalTitle} style={{ fontSize: `${fontSizes.professionalTitle}pt` }}>
              {formData.professionalTitle}
            </h2>
          )}
        ...
        {hasSkills && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>SKILLS</h2>
          ...
          <section className={styles.section}>
            ...
            {formData.certifications.map((c, i) => (
              <div key={i} className={styles.certificationItem} style={{ fontSize: `${fontSizes.certificationText}pt` }}>
                ...
                {c.credentialNumber && ` (Credential #: ${c.credentialNumber})`}
        ...
        {hasAchievements && (
          <section className={styles.section}>
            <h2 className={styles.sectionTitle} style={{ fontSize: `${fontSizes.sectionTitle}pt` }}>ACHIEVEMENTS</h2>
            <ul className={styles.bulletList}>
              {formData.achievements.map((a, i) => (
                <li key={i} style={{ fontSize: `${fontSizes.bulletText}pt` }}>
                  <strong>{a.title}</strong>{a.year && ` (${a.year})`}{a.description && ` – ${a.description}`}
                </li>
              ))}
            </ul>
          </section>
            ...
            {formData.projects.map((p, i) => (
              <div key={i} className={styles.experienceItem}>
                <div className={styles.experienceHeader}>
                  ...
                  {p.year && <p className={styles.company} style={{ fontSize: `${fontSizes.company}pt` }}>{p.year}</p>}
                </div>
                {p.description && <p className={styles.summaryText} style={{ fontSize: `${fontSizes.regularText}pt` }}>{p.description}</p>}
                {p.technologies && (
    ...
    <div className={styles.resumeBuilder} lang="en-US">
      ...
      <nav className={styles.breadcrumb} aria-label="Breadcrumb">
        <ol>
          ...
          <li>
            <Link href="/free-resume-builder" className={styles.breadcrumbLink} prefetch={false}>
              <span className={styles.breadcrumbText}>Free Professional Template</span>
            </Link>
          </li>
        </ol>
      </nav>
          ...
          <div className={styles.heroContent}>
            <div className={styles.trustBadge}>
              ...
              <span className={styles.trustBadgeText}>
                Rated 4.9/5 by 60365+ Professionals | Best Free Resume Builder 2026
              </span>
            </div>
            ...
            <div className={styles.ctaButtons}>
              <button
                ...
                aria-label="Start building your free professional resume now—no sign-up required"
              >
              ...
              >
                ...
                <span className={styles.buttonText}>Download Resume PDF</span>
              </button>
            </div>
            ...
            <div className={styles.heroStats}>
              ...
              <div className={styles.statItem}>
                ...
                <span className={styles.statLabel}>Professional Rating</span>
              </div>
            </div>

            <div className={styles.industryBadges}>
              <div className={styles.badgeGrid}>
                <span className={styles.badgeItem}><FiCode /> Tech</span>
                <span className={styles.badgeItem}><FiBriefcase /> Business</span>
                <span className={styles.badgeItem}><FiDollarSign /> Finance</span>
                <span className={styles.badgeItem}><FiShoppingBag /> Marketing</span>
                <span className={styles.badgeItem}><FiTool /> Engineering</span>
                <span className={styles.badgeItem}><FiHeart /> Healthcare</span>
                <span className={styles.badgeItem}><FiMonitor /> Creative</span>
                <span className={styles.badgeItem}><FiTruck /> Operations</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.resumePreviewCard}>
              <div className={styles.previewContent}>
                <div
                  ...
                  ref={resumeRef}
                >
                  <UniversalTemplate formData={formData} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.formContent}>
              ...
              <div className={styles.formSectionContent}>
                ...
                <div className={styles.formCard}>
                  <div className={styles.formGroup}>
                    ...
                    <label className={styles.formLabel}>
                      Professional Title
                      <input type="text" name="professionalTitle" value={formData.professionalTitle} onChange={handleInputChange} placeholder="Senior Project Manager | MBA" className={styles.formInput} />
                    </label>
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
            ...
            {activeSection === 'experience' && (
              <div className={styles.formSectionContent}>
                ...
                <p className={styles.sectionDescription}>List your positions in reverse chronological order (most recent first)</p>
...
• Mentored 5 junior project managers in project management best practices"
                ...
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Your Experience</h4>
                  {formData.experience.length === 0 ? (
                ...
                <div className={styles.formCard}>
                  ...
                  <p className={styles.sectionDescription}>Highlight significant accomplishments, awards, or recognitions</p>
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        ...
                        <input 
                          ...
                          placeholder="Project of the Year Award" 
                          className={styles.formInput} 
                        />
                      </label>
                      <label className={styles.formLabel}>
                    ...
                    <label className={styles.formLabel}>
                      ...
                      <textarea 
                        ...
                        placeholder="Recognized for leading a critical project that resulted in 40% cost savings" 
                        className={styles.formTextarea} 
                        rows="3" 
                      />
                    </label>
            ...
            {activeSection === 'skills' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiTool /> Skills & Expertise</h3>
                
                {/* Skills */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Professional Skills</h4>
                  <p className={styles.sectionDescription}>List your technical and soft skills by category</p>
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        Skill Name*
                ...
                <div className={styles.formCard}>
                  ...
                  <p className={styles.sectionDescription}>Add your professional certifications and credentials</p>
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        Certification Name*
                ...
                {/* Projects */}
                <div className={styles.formCard}>
                  <h4 className={styles.subSectionTitle}>Notable Projects</h4>
                  <p className={styles.sectionDescription}>Highlight key projects that demonstrate your capabilities</p>
                  <div className={styles.skillsInput}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>
                        Project Name*
                    ...
                    <label className={styles.formLabel}>
                      ...
                      <textarea 
                        ...
                        placeholder="Led the implementation of a new CRM system for a 500-employee company, resulting in 30% increase in sales productivity." 
                        className={styles.formTextarea} 
                        rows="3" 
                      />
                    </label>
                    <label className={styles.formLabel}>
                      ...
                      <input 
                        ...
                        placeholder="Salesforce, Jira, Python, SQL" 
                        className={styles.formInput} 
                      />
                    </label>
                    <div className={styles.formActions}>
                    ...
                    {formData.projects.map((p, i) => (
                      <div key={i} className={styles.listItem}>
                        <div>
                          ...
                          {p.technologies && <div className={styles.itemMeta}><strong>Technologies:</strong> {p.technologies}</div>}
                        </div>
                        <div className={styles.itemActions}>
            ...
            {activeSection === 'certifications' && (
              <div className={styles.formSectionContent}>
                <h3 className={styles.sectionTitle}><FiAward /> Certifications & Credentials</h3>
                <p className={styles.sectionDescription}>Showcase your professional certifications, licenses, and credentials</p>
                  ...
                  <div className={styles.fontSizeGrid}>
                    ...
                    <div className={styles.fontSizeControl}>
                      <label className={styles.fontSizeLabel}>
                        ...
                        <span className={styles.fontSizeValue}>{fontSizes.professionalTitle}pt</span>
                      </label>
                      <input 
                        type="range" 
                        min="6" 
                        max="18" 
                        value={fontSizes.professionalTitle}
                        onChange={(e) => handleFontSizeChange('professionalTitle', e.target.value)}
                        className={styles.fontSizeSlider}
                      />
                    </div>
          ...
          <div className={styles.ctaContent}>
            ...
            <div className={styles.ctaButtons}>
              <button
                ...
                aria-label="Create your free professional resume now—no sign-up required"
              >
                <span className={styles.ctaButtonText}>Create Your Free Resume Now</span>
